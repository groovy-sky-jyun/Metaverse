...
<?php
	...
	$record_sql = "SELECT * FROM messagerecord WHERE read_check = 0 AND list_number = '".$number."'";
	...
	$update_sql = "UPDATE messagerecord SET read_check=1 WHERE read_check = 0 AND list_number = '".$number."'";
	$update_result = mysqli_query($conn, $update_sql);	
	if(!mysqli_fetch_assoc($update_result)){
		echo "fail";
	}
